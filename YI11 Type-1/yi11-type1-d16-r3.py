...
def set_smtlib2_stp(rounds):
    ...
    for r in range(rounds):
        ...
        smtlib2_constr.append(f"(assert (= y_4_{r}_1 y_6_{r}_0))\n")
        smtlib2_constr.append(f"(assert (= y_5_{r}_1 y_7_{r}_0))\n")
        smtlib2_constr.append(f"(assert (= y_6_{r}_1 y_8_{r}_0))\n")
        smtlib2_constr.append(f"(assert (= y_7_{r}_1 y_9_{r}_0))\n")
        smtlib2_constr.append(f"(assert (= y_8_{r}_1 y_10_{r}_0))\n")
        smtlib2_constr.append(f"(assert (= y_9_{r}_1 y_11_{r}_0))\n")
        smtlib2_constr.append(f"(assert (= y_10_{r}_1 y_12_{r}_0))\n")
        smtlib2_constr.append(f"(assert (= y_11_{r}_1 y_13_{r}_0))\n")
        smtlib2_constr.append(f"(assert (= y_12_{r}_1 y_1_{r}_0))\n")
    ...
    smtlib2_constr.append(f"(assert (= y_0_{rounds-1}_1 #b00))\n")
    smtlib2_constr.append("\n")
    smtlib2_constr.append(
