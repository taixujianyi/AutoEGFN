...
def set_smtlib2_stp(rounds):
    ...
    for r in range(rounds):
        ...
        # Perm (2,3,4,5,1,6,7,8,9,0)
        smtlib2_constr.append(f"(assert (= y_0_{r} x_9_{r}_0))\n")
        smtlib2_constr.append(f"(assert (= y_1_{r} x_4_{r}_0))\n")
    ...
    smtlib2_constr.append(
        "(assert (not (= (concat (concat (concat (concat (concat x_0_0_0 x_1_0_0) (concat x_2_0_0 x_3_0_0)) (concat x_4_0_0 x_5_0_0)) (concat x_6_0_0 x_7_0_0)) (concat x_8_0_0 x_9_0_0)) #b00000000000000000000)))\n"
    )
    for i in range(10):
