...
def set_smtlib2_stp(rounds):
    ...
    for r in range(rounds):
        ...
        smtlib2_constr.append(f"(assert (= y_10_{r}_1 y_0_{r}_0))\n")
    ...
    smtlib2_constr.append(
        "(assert (not (= (concat (concat (concat (concat (concat y_0_0_0 (concat y_1_0_0 y_2_0_0)) (concat y_3_0_0 y_4_0_0)) (concat y_5_0_0 y_6_0_0)) (concat y_7_0_0 y_8_0_0)) (concat y_9_0_0 y_10_0_0)) #b0000000000000000000000)))\n"
    )
