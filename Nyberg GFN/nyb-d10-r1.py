...
def set_smtlib2(rounds):
    ...
    for r in range(rounds):
        ...
        smtlib2_constr.append(f"(declare-fun x_5_{r}_1 () (_ BitVec 2))\n")
    ...
    for r in range(rounds):
        ...
        smtlib2_constr.append(f"(assert (= x_5_{r}_1 (ite (= x_5_{r}_0 #b00) #b00 #b11)))\n")
        smtlib2_constr.append("\n")

        # XOR operations
        smtlib2_constr.append(
            f"(assert (= z_0_{r}_0\n"
            f"    (ite (= x_5_{r}_1 #b00) x_4_{r}_0\n"
            f"         (ite (and (= x_5_{r}_1 #b01) (= x_4_{r}_0 #b00)) #b01\n"
            f"         (ite (and (= x_5_{r}_1 #b01) (= x_4_{r}_0 #b01)) #b01\n"
            f"         (ite (and (= x_5_{r}_1 #b01) (= x_4_{r}_0 #b10)) #b11\n"
            f"         (ite (and (= x_5_{r}_1 #b01) (= x_4_{r}_0 #b11)) #b11\n"
            f"         (ite (and (= x_5_{r}_1 #b10) (= x_4_{r}_0 #b00)) #b10\n"
            f"         (ite (and (= x_5_{r}_1 #b10) (= x_4_{r}_0 #b01)) #b11\n"
            f"         (ite (and (= x_5_{r}_1 #b10) (= x_4_{r}_0 #b10)) #b10\n"
            f"         (ite (and (= x_5_{r}_1 #b10) (= x_4_{r}_0 #b11)) #b11\n"
            f"         (ite (= x_5_{r}_1 #b11) #b11 #b00))))))))))))\n"
        )
        
        smtlib2_constr.append(
            f"(assert (= z_1_{r}_0\n"
            f"    (ite (= x_6_{r}_1 #b00) x_3_{r}_0\n"
            f"         (ite (and (= x_6_{r}_1 #b01) (= x_3_{r}_0 #b00)) #b01\n"
            f"         (ite (and (= x_6_{r}_1 #b01) (= x_3_{r}_0 #b01)) #b01\n"
            f"         (ite (and (= x_6_{r}_1 #b01) (= x_3_{r}_0 #b10)) #b11\n"
            f"         (ite (and (= x_6_{r}_1 #b01) (= x_3_{r}_0 #b11)) #b11\n"
            f"         (ite (and (= x_6_{r}_1 #b10) (= x_3_{r}_0 #b00)) #b10\n"
            f"         (ite (and (= x_6_{r}_1 #b10) (= x_3_{r}_0 #b01)) #b11\n"
            f"         (ite (and (= x_6_{r}_1 #b10) (= x_3_{r}_0 #b10)) #b10\n"
            f"         (ite (and (= x_6_{r}_1 #b10) (= x_3_{r}_0 #b11)) #b11\n"
            f"         (ite (= x_6_{r}_1 #b11) #b11 #b00))))))))))))\n"
        )
        
        smtlib2_constr.append(
            f"(assert (= z_2_{r}_0\n"
            f"    (ite (= x_7_{r}_1 #b00) x_2_{r}_0\n"
            f"         (ite (and (= x_7_{r}_1 #b01) (= x_2_{r}_0 #b00)) #b01\n"
            f"         (ite (and (= x_7_{r}_1 #b01) (= x_2_{r}_0 #b01)) #b01\n"
            f"         (ite (and (= x_7_{r}_1 #b01) (= x_2_{r}_0 #b10)) #b11\n"
            f"         (ite (and (= x_7_{r}_1 #b01) (= x_2_{r}_0 #b11)) #b11\n"
            f"         (ite (and (= x_7_{r}_1 #b10) (= x_2_{r}_0 #b00)) #b10\n"
            f"         (ite (and (= x_7_{r}_1 #b10) (= x_2_{r}_0 #b01)) #b11\n"
            f"         (ite (and (= x_7_{r}_1 #b10) (= x_2_{r}_0 #b10)) #b10\n"
            f"         (ite (and (= x_7_{r}_1 #b10) (= x_2_{r}_0 #b11)) #b11\n"
            f"         (ite (= x_7_{r}_1 #b11) #b11 #b00))))))))))))\n"
        )
        
        smtlib2_constr.append(
            f"(assert (= z_3_{r}_0\n"
            f"    (ite (= x_8_{r}_1 #b00) x_1_{r}_0\n"
            f"         (ite (and (= x_8_{r}_1 #b01) (= x_1_{r}_0 #b00)) #b01\n"
            f"         (ite (and (= x_8_{r}_1 #b01) (= x_1_{r}_0 #b01)) #b01\n"
            f"         (ite (and (= x_8_{r}_1 #b01) (= x_1_{r}_0 #b10)) #b11\n"
            f"         (ite (and (= x_8_{r}_1 #b01) (= x_1_{r}_0 #b11)) #b11\n"
            f"         (ite (and (= x_8_{r}_1 #b10) (= x_1_{r}_0 #b00)) #b10\n"
            f"         (ite (and (= x_8_{r}_1 #b10) (= x_1_{r}_0 #b01)) #b11\n"
            f"         (ite (and (= x_8_{r}_1 #b10) (= x_1_{r}_0 #b10)) #b10\n"
            f"         (ite (and (= x_8_{r}_1 #b10) (= x_1_{r}_0 #b11)) #b11\n"
            f"         (ite (= x_8_{r}_1 #b11) #b11 #b00))))))))))))\n"
        )
        
        smtlib2_constr.append(
            f"(assert (= z_4_{r}_0\n"
            f"    (ite (= x_9_{r}_1 #b00) x_0_{r}_0\n"
            f"         (ite (and (= x_9_{r}_1 #b01) (= x_0_{r}_0 #b00)) #b01\n"
            f"         (ite (and (= x_9_{r}_1 #b01) (= x_0_{r}_0 #b01)) #b01\n"
            f"         (ite (and (= x_9_{r}_1 #b01) (= x_0_{r}_0 #b10)) #b11\n"
            f"         (ite (and (= x_9_{r}_1 #b01) (= x_0_{r}_0 #b11)) #b11\n"
            f"         (ite (and (= x_9_{r}_1 #b10) (= x_0_{r}_0 #b00)) #b10\n"
            f"         (ite (and (= x_9_{r}_1 #b10) (= x_0_{r}_0 #b01)) #b11\n"
            f"         (ite (and (= x_9_{r}_1 #b10) (= x_0_{r}_0 #b10)) #b10\n"
            f"         (ite (and (= x_9_{r}_1 #b10) (= x_0_{r}_0 #b11)) #b11\n"
            f"         (ite (= x_9_{r}_1 #b11) #b11 #b00))))))))))))\n"
        )
        smtlib2_constr.append("\n")

        # Permutation
        smtlib2_constr.append(f"(assert (= y_0_{r} x_9_{r}_0))\n")
        smtlib2_constr.append(f"(assert (= y_1_{r} z_4_{r}_0))\n")
        smtlib2_constr.append(f"(assert (= y_2_{r} z_3_{r}_0))\n")
        smtlib2_constr.append(f"(assert (= y_3_{r} z_2_{r}_0))\n")
        smtlib2_constr.append(f"(assert (= y_4_{r} z_1_{r}_0))\n")
        smtlib2_constr.append(f"(assert (= y_5_{r} z_0_{r}_0))\n")
    ...
    smtlib2_constr.append(f"(assert (= (bvand x_8_{rounds-1}_0 (bvand x_9_{rounds-1}_0 (bvand x_7_{rounds-1}_0 (bvand x_6_{rounds-1}_0 x_5_{rounds-1}_0)))) #b00))\n\n")
    smtlib2_constr.append(
        "(assert (not (= (concat x_0_0_0 (concat x_1_0_0 (concat x_2_0_0 (concat x_3_0_0 (concat x_4_0_0 (concat x_5_0_0 (concat x_6_0_0 (concat x_7_0_0 (concat x_8_0_0 x_9_0_0))))))))) #b00000000000000000000)))\n"
    )
