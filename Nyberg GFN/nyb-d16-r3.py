...
def set_smtlib2(rounds):
    ...
    for r in range(rounds):
        ...
        smtlib2_constr.append(
            f"(assert (= z_0_{r}_0\n"
            f"    (ite (= y_15_{r}_2 #b00) y_0_{r}_1\n"
            f"         (ite (and (= y_15_{r}_2 #b01) (= y_0_{r}_1 #b00)) #b01\n"
            f"         (ite (and (= y_15_{r}_2 #b01) (= y_0_{r}_1 #b01)) #b01\n"
            f"         (ite (and (= y_15_{r}_2 #b01) (= y_0_{r}_1 #b10)) #b11\n"
            f"         (ite (and (= y_15_{r}_2 #b01) (= y_0_{r}_1 #b11)) #b11\n"
            f"         (ite (and (= y_15_{r}_2 #b10) (= y_0_{r}_1 #b00)) #b10\n"
            f"         (ite (and (= y_15_{r}_2 #b10) (= y_0_{r}_1 #b01)) #b11\n"
            f"         (ite (and (= y_15_{r}_2 #b10) (= y_0_{r}_1 #b10)) #b10\n"
            f"         (ite (and (= y_15_{r}_2 #b10) (= y_0_{r}_1 #b11)) #b11\n"
            f"         (ite (= y_15_{r}_2 #b11) #b11 #b00))))))))))))\n"
        )
        
        # z_1
        smtlib2_constr.append(
            f"(assert (= z_1_{r}_0\n"
            f"    (ite (= y_14_{r}_2 #b00) y_1_{r}_1\n"
            f"         (ite (and (= y_14_{r}_2 #b01) (= y_1_{r}_1 #b00)) #b01\n"
            f"         (ite (and (= y_14_{r}_2 #b01) (= y_1_{r}_1 #b01)) #b01\n"
            f"         (ite (and (= y_14_{r}_2 #b01) (= y_1_{r}_1 #b10)) #b11\n"
            f"         (ite (and (= y_14_{r}_2 #b01) (= y_1_{r}_1 #b11)) #b11\n"
            f"         (ite (and (= y_14_{r}_2 #b10) (= y_1_{r}_1 #b00)) #b10\n"
            f"         (ite (and (= y_14_{r}_2 #b10) (= y_1_{r}_1 #b01)) #b11\n"
            f"         (ite (and (= y_14_{r}_2 #b10) (= y_1_{r}_1 #b10)) #b10\n"
            f"         (ite (and (= y_14_{r}_2 #b10) (= y_1_{r}_1 #b11)) #b11\n"
        ...
        smtlib2_constr.append(
            f"(assert (= z_2_{r}_0\n"
            f"    (ite (= y_13_{r}_2 #b00) y_2_{r}_1\n"
            f"         (ite (and (= y_13_{r}_2 #b01) (= y_2_{r}_1 #b00)) #b01\n"
            f"         (ite (and (= y_13_{r}_2 #b01) (= y_2_{r}_1 #b01)) #b01\n"
            f"         (ite (and (= y_13_{r}_2 #b01) (= y_2_{r}_1 #b10)) #b11\n"
            f"         (ite (and (= y_13_{r}_2 #b01) (= y_2_{r}_1 #b11)) #b11\n"
            f"         (ite (and (= y_13_{r}_2 #b10) (= y_2_{r}_1 #b00)) #b10\n"
            f"         (ite (and (= y_13_{r}_2 #b10) (= y_2_{r}_1 #b01)) #b11\n"
            f"         (ite (and (= y_13_{r}_2 #b10) (= y_2_{r}_1 #b10)) #b10\n"
            f"         (ite (and (= y_13_{r}_2 #b10) (= y_2_{r}_1 #b11)) #b11\n"
        ...
        smtlib2_constr.append(
            f"(assert (= z_3_{r}_0\n"
            f"    (ite (= y_12_{r}_2 #b00) y_3_{r}_1\n"
            f"         (ite (and (= y_12_{r}_2 #b01) (= y_3_{r}_1 #b00)) #b01\n"
            f"         (ite (and (= y_12_{r}_2 #b01) (= y_3_{r}_1 #b01)) #b01\n"
            f"         (ite (and (= y_12_{r}_2 #b01) (= y_3_{r}_1 #b10)) #b11\n"
            f"         (ite (and (= y_12_{r}_2 #b01) (= y_3_{r}_1 #b11)) #b11\n"
            f"         (ite (and (= y_12_{r}_2 #b10) (= y_3_{r}_1 #b00)) #b10\n"
            f"         (ite (and (= y_12_{r}_2 #b10) (= y_3_{r}_1 #b01)) #b11\n"
            f"         (ite (and (= y_12_{r}_2 #b10) (= y_3_{r}_1 #b10)) #b10\n"
            f"         (ite (and (= y_12_{r}_2 #b10) (= y_3_{r}_1 #b11)) #b11\n"
        ...
        smtlib2_constr.append(
            f"(assert (= z_4_{r}_0\n"
            f"    (ite (= y_11_{r}_2 #b00) y_4_{r}_1\n"
            f"         (ite (and (= y_11_{r}_2 #b01) (= y_4_{r}_1 #b00)) #b01\n"
            f"         (ite (and (= y_11_{r}_2 #b01) (= y_4_{r}_1 #b01)) #b01\n"
            f"         (ite (and (= y_11_{r}_2 #b01) (= y_4_{r}_1 #b10)) #b11\n"
            f"         (ite (and (= y_11_{r}_2 #b01) (= y_4_{r}_1 #b11)) #b11\n"
            f"         (ite (and (= y_11_{r}_2 #b10) (= y_4_{r}_1 #b00)) #b10\n"
            f"         (ite (and (= y_11_{r}_2 #b10) (= y_4_{r}_1 #b01)) #b11\n"
            f"         (ite (and (= y_11_{r}_2 #b10) (= y_4_{r}_1 #b10)) #b10\n"
            f"         (ite (and (= y_11_{r}_2 #b10) (= y_4_{r}_1 #b11)) #b11\n"
        ...
        smtlib2_constr.append(
            f"(assert (= z_5_{r}_0\n"
            f"    (ite (= y_10_{r}_2 #b00) y_5_{r}_1\n"
            f"         (ite (and (= y_10_{r}_2 #b01) (= y_5_{r}_1 #b00)) #b01\n"
            f"         (ite (and (= y_10_{r}_2 #b01) (= y_5_{r}_1 #b01)) #b01\n"
            f"         (ite (and (= y_10_{r}_2 #b01) (= y_5_{r}_1 #b10)) #b11\n"
            f"         (ite (and (= y_10_{r}_2 #b01) (= y_5_{r}_1 #b11)) #b11\n"
            f"         (ite (and (= y_10_{r}_2 #b10) (= y_5_{r}_1 #b00)) #b10\n"
            f"         (ite (and (= y_10_{r}_2 #b10) (= y_5_{r}_1 #b01)) #b11\n"
            f"         (ite (and (= y_10_{r}_2 #b10) (= y_5_{r}_1 #b10)) #b10\n"
            f"         (ite (and (= y_10_{r}_2 #b10) (= y_5_{r}_1 #b11)) #b11\n"
        ...
        smtlib2_constr.append(
            f"(assert (= z_6_{r}_0\n"
            f"    (ite (= y_9_{r}_2 #b00) y_6_{r}_1\n"
            f"         (ite (and (= y_9_{r}_2 #b01) (= y_6_{r}_1 #b00)) #b01\n"
            f"         (ite (and (= y_9_{r}_2 #b01) (= y_6_{r}_1 #b01)) #b01\n"
            f"         (ite (and (= y_9_{r}_2 #b01) (= y_6_{r}_1 #b10)) #b11\n"
            f"         (ite (and (= y_9_{r}_2 #b01) (= y_6_{r}_1 #b11)) #b11\n"
            f"         (ite (and (= y_9_{r}_2 #b10) (= y_6_{r}_1 #b00)) #b10\n"
            f"         (ite (and (= y_9_{r}_2 #b10) (= y_6_{r}_1 #b01)) #b11\n"
            f"         (ite (and (= y_9_{r}_2 #b10) (= y_6_{r}_1 #b10)) #b10\n"
            f"         (ite (and (= y_9_{r}_2 #b10) (= y_6_{r}_1 #b11)) #b11\n"
        ...
        smtlib2_constr.append(
            f"(assert (= z_7_{r}_0\n"
            f"    (ite (= y_8_{r}_2 #b00) y_7_{r}_1\n"
            f"         (ite (and (= y_8_{r}_2 #b01) (= y_7_{r}_1 #b00)) #b01\n"
            f"         (ite (and (= y_8_{r}_2 #b01) (= y_7_{r}_1 #b01)) #b01\n"
            f"         (ite (and (= y_8_{r}_2 #b01) (= y_7_{r}_1 #b10)) #b11\n"
            f"         (ite (and (= y_8_{r}_2 #b01) (= y_7_{r}_1 #b11)) #b11\n"
            f"         (ite (and (= y_8_{r}_2 #b10) (= y_7_{r}_1 #b00)) #b10\n"
            f"         (ite (and (= y_8_{r}_2 #b10) (= y_7_{r}_1 #b01)) #b11\n"
            f"         (ite (and (= y_8_{r}_2 #b10) (= y_7_{r}_1 #b10)) #b10\n"
            f"         (ite (and (= y_8_{r}_2 #b10) (= y_7_{r}_1 #b11)) #b11\n"
