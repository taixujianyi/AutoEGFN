...
def set_smtlib2(rounds):
    ...
    for r in range(rounds):
        ...
        # XOR
        smtlib2_constr.append(f"(assert (= (Table (concat (concat x_8_{r}_1 x_7_{r}_0) z_0_{r}_0)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat x_9_{r}_1 x_6_{r}_0) z_1_{r}_0)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat x_10_{r}_1 x_5_{r}_0) z_2_{r}_0)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat x_11_{r}_1 x_4_{r}_0) z_3_{r}_0)) #b1))\n")
        
        smtlib2_constr.append(f"(assert (= (Table (concat (concat x_12_{r}_1 x_3_{r}_0) z_4_{r}_0)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat x_13_{r}_1 x_2_{r}_0) z_5_{r}_0)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat x_14_{r}_1 x_1_{r}_0) z_6_{r}_0)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat x_15_{r}_1 x_0_{r}_0) z_7_{r}_0)) #b1))\n")
