...
def set_smtlib2(rounds):
    ...
    for r in range(rounds):
        ...
        smtlib2_constr.append(
            f"(assert (= z_2_{r}_0\n"
            f"    (ite (= z_1_{r}_0 #b00) x_3_{r}_1\n"
            f"         (ite (and (= z_1_{r}_0 #b01) (= x_3_{r}_1 #b00)) #b01\n"
            f"         (ite (and (= z_1_{r}_0 #b01) (= x_3_{r}_1 #b01)) #b01\n"
            f"         (ite (and (= z_1_{r}_0 #b01) (= x_3_{r}_1 #b10)) #b11\n"
            f"         (ite (and (= z_1_{r}_0 #b01) (= x_3_{r}_1 #b11)) #b11\n"
            f"         (ite (and (= z_1_{r}_0 #b10) (= x_3_{r}_1 #b00)) #b10\n"
            f"         (ite (and (= z_1_{r}_0 #b10) (= x_3_{r}_1 #b01)) #b11\n"
            f"         (ite (and (= z_1_{r}_0 #b10) (= x_3_{r}_1 #b10)) #b10\n"
            f"         (ite (and (= z_1_{r}_0 #b10) (= x_3_{r}_1 #b11)) #b11\n"
        ...
        smtlib2_constr.append(
            f"(assert (= z_3_{r}_0\n"
            f"    (ite (= z_2_{r}_0 #b00) x_4_{r}_0\n"
            f"         (ite (and (= z_2_{r}_0 #b01) (= x_4_{r}_0 #b00)) #b01\n"
            f"         (ite (and (= z_2_{r}_0 #b01) (= x_4_{r}_0 #b01)) #b01\n"
            f"         (ite (and (= z_2_{r}_0 #b01) (= x_4_{r}_0 #b10)) #b11\n"
            f"         (ite (and (= z_2_{r}_0 #b01) (= x_4_{r}_0 #b11)) #b11\n"
            f"         (ite (and (= z_2_{r}_0 #b10) (= x_4_{r}_0 #b00)) #b10\n"
            f"         (ite (and (= z_2_{r}_0 #b10) (= x_4_{r}_0 #b01)) #b11\n"
            f"         (ite (and (= z_2_{r}_0 #b10) (= x_4_{r}_0 #b10)) #b10\n"
            f"         (ite (and (= z_2_{r}_0 #b10) (= x_4_{r}_0 #b11)) #b11\n"
            f"         (ite (= z_2_{r}_0 #b11) #b11 #b00))))))))))))\n"
        )
        smtlib2_constr.append("\n")

        # Permutation (1 2 3 4 0)
        smtlib2_constr.append(f"(assert (= y_0_{r} z_3_{r}_0))\n")
    ...
    concat_expr = "(concat x_0_0_0 (concat x_1_0_0 (concat x_2_0_0 (concat x_3_0_0 x_4_0_0))))"
