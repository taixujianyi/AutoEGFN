...
def set_cvc(round):
    ...
    for r in range(round):
        ...
        cvc_constr.append("ASSERT IF y_0_{0}_2=0bin00 THEN z_4_{0}_0=y_5_{0}_1 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_0_{0}_2=0bin01 AND y_5_{0}_1=0bin00 THEN z_4_{0}_0=0bin01 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_0_{0}_2=0bin01 AND y_5_{0}_1=0bin01 THEN z_4_{0}_0=0bin00 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_0_{0}_2=0bin01 AND y_5_{0}_1=0bin10 THEN z_4_{0}_0=0bin11 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_0_{0}_2=0bin01 AND y_5_{0}_1=0bin11 THEN z_4_{0}_0=0bin11 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_0_{0}_2=0bin10 AND y_5_{0}_1=0bin00 THEN z_4_{0}_0=0bin10 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_0_{0}_2=0bin10 AND y_5_{0}_1=0bin01 THEN z_4_{0}_0=0bin11 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_0_{0}_2=0bin10 AND y_5_{0}_1=0bin10 THEN z_4_{0}_0=0bin00 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_0_{0}_2=0bin10 AND y_5_{0}_1=0bin11 THEN z_4_{0}_0=0bin11 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_0_{0}_2=0bin11 THEN z_4_{0}_0=0bin11 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("\n")

        cvc_constr.append("ASSERT IF y_0_{0}_2=0bin00 THEN z_5_{0}_0=y_6_{0}_1 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_0_{0}_2=0bin01 AND y_6_{0}_1=0bin00 THEN z_5_{0}_0=0bin01 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_0_{0}_2=0bin01 AND y_6_{0}_1=0bin01 THEN z_5_{0}_0=0bin00 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_0_{0}_2=0bin01 AND y_6_{0}_1=0bin10 THEN z_5_{0}_0=0bin11 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_0_{0}_2=0bin01 AND y_6_{0}_1=0bin11 THEN z_5_{0}_0=0bin11 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_0_{0}_2=0bin10 AND y_6_{0}_1=0bin00 THEN z_5_{0}_0=0bin10 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_0_{0}_2=0bin10 AND y_6_{0}_1=0bin01 THEN z_5_{0}_0=0bin11 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_0_{0}_2=0bin10 AND y_6_{0}_1=0bin10 THEN z_5_{0}_0=0bin00 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_0_{0}_2=0bin10 AND y_6_{0}_1=0bin11 THEN z_5_{0}_0=0bin11 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_0_{0}_2=0bin11 THEN z_5_{0}_0=0bin11 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("\n")

        cvc_constr.append("ASSERT IF y_0_{0}_2=0bin00 THEN z_6_{0}_0=y_7_{0}_1 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_0_{0}_2=0bin01 AND y_7_{0}_1=0bin00 THEN z_6_{0}_0=0bin01 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_0_{0}_2=0bin01 AND y_7_{0}_1=0bin01 THEN z_6_{0}_0=0bin00 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_0_{0}_2=0bin01 AND y_7_{0}_1=0bin10 THEN z_6_{0}_0=0bin11 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_0_{0}_2=0bin01 AND y_7_{0}_1=0bin11 THEN z_6_{0}_0=0bin11 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_0_{0}_2=0bin10 AND y_7_{0}_1=0bin00 THEN z_6_{0}_0=0bin10 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_0_{0}_2=0bin10 AND y_7_{0}_1=0bin01 THEN z_6_{0}_0=0bin11 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_0_{0}_2=0bin10 AND y_7_{0}_1=0bin10 THEN z_6_{0}_0=0bin00 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_0_{0}_2=0bin10 AND y_7_{0}_1=0bin11 THEN z_6_{0}_0=0bin11 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_0_{0}_2=0bin11 THEN z_6_{0}_0=0bin11 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("\n")
