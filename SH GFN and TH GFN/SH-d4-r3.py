...
def set_smtlib2(rounds):
    ...
    for r in range(rounds):
        ...
        smtlib2_constr.append(
            f"(assert (= z_2_{r}_0\n"
            f"    (ite (= z_1_{r}_0 #b00) y_3_{r}_1\n"
            f"         (ite (and (= z_1_{r}_0 #b01) (= y_3_{r}_1 #b00)) #b01\n"
            f"         (ite (and (= z_1_{r}_0 #b01) (= y_3_{r}_1 #b01)) #b01\n"
            f"         (ite (and (= z_1_{r}_0 #b01) (= y_3_{r}_1 #b10)) #b11\n"
            f"         (ite (and (= z_1_{r}_0 #b01) (= y_3_{r}_1 #b11)) #b11\n"
            f"         (ite (and (= z_1_{r}_0 #b10) (= y_3_{r}_1 #b00)) #b10\n"
            f"         (ite (and (= z_1_{r}_0 #b10) (= y_3_{r}_1 #b01)) #b11\n"
            f"         (ite (and (= z_1_{r}_0 #b10) (= y_3_{r}_1 #b10)) #b10\n"
            f"         (ite (and (= z_1_{r}_0 #b10) (= y_3_{r}_1 #b11)) #b11\n"
    ...
    smtlib2_constr.append("(assert (not (= (concat y_0_0_0 (concat y_1_0_0 (concat y_2_0_0 y_3_0_0))) #b00000000)))\n")
    for i in range(4):
