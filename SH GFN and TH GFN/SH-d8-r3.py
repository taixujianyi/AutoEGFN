...
def set_smtlib2(rounds):
    ...
    for r in range(rounds):
        ...
        # XOR
        smtlib2_constr.append(f"(assert (= (Table (concat (concat y_0_{r}_2 y_1_{r}_2) z_0_{r}_0)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat z_0_{r}_0 y_2_{r}_2) z_1_{r}_0)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat z_1_{r}_0 y_3_{r}_2) z_2_{r}_0)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat z_2_{r}_0 y_4_{r}_2) z_3_{r}_0)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat z_3_{r}_0 y_5_{r}_2) z_4_{r}_0)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat z_4_{r}_0 y_6_{r}_2) z_5_{r}_0)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat z_5_{r}_0 y_7_{r}_1) z_6_{r}_0)) #b1))\n")
        ...
        smtlib2_constr.append(f"(assert (= x_7_{r}_0 z_6_{r}_0))\n\n")
    ...
    smtlib2_constr.append(f"(assert (= active_5 (ite (= y_4_{rounds-1}_1 #b00) #b0 #b1)))\n")
    smtlib2_constr.append(f"(assert (= active_6 (ite (= y_5_{rounds-1}_1 #b00) #b0 #b1)))\n")
    smtlib2_constr.append(f"(assert (= active_7 (ite (= y_6_{rounds-1}_1 #b00) #b0 #b1)))\n")
    ...
    concat_terms = [f"y_{i}_0_0" for i in range(8)]
