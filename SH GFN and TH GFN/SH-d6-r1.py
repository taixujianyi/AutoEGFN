...
def set_smtlib2(rounds):
    ...
    for r in range(rounds):
        ...
        smtlib2_constr.append(f"(assert (= (Table (concat (concat z_3_{r}_0 x_5_{r}_0) z_4_{r}_0)) #b1))\n")
    ...
    # Non-zero initial state constraint
    concat_terms = [f"x_{i}_0_0" for i in range(6)]
