...
def set_smtlib2(rounds):
    ...
    for r in range(rounds):
        ...
        smtlib2_constr.append(f"(assert (= (Table (concat (concat x_0_{r}_1 x_2_{r}_0) z_1_{r}_0)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat x_0_{r}_1 x_3_{r}_0) z_2_{r}_0)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat x_0_{r}_1 x_4_{r}_0) z_3_{r}_0)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat x_0_{r}_1 x_5_{r}_0) z_4_{r}_0)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat x_0_{r}_1 x_6_{r}_0) z_5_{r}_0)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat x_0_{r}_1 x_7_{r}_0) z_6_{r}_0)) #b1))\n")
        ...
        smtlib2_constr.append(f"(assert (= y_7_{r} z_5_{r}_0))\n\n")
