...
def set_cvc(round):
    ...
    for r in range(round):
        ...
        cvc_constr.append("ASSERT IF z_0_{0}_0=0bin00 THEN z_1_{0}_0=x_2_{0}_0 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF z_0_{0}_0=0bin01 AND x_2_{0}_0=0bin00 THEN z_1_{0}_0=0bin01 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF z_0_{0}_0=0bin01 AND x_2_{0}_0=0bin01 THEN z_1_{0}_0=0bin00 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF z_0_{0}_0=0bin01 AND x_2_{0}_0=0bin10 THEN z_1_{0}_0=0bin11 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF z_0_{0}_0=0bin01 AND x_2_{0}_0=0bin11 THEN z_1_{0}_0=0bin11 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF z_0_{0}_0=0bin10 AND x_2_{0}_0=0bin00 THEN z_1_{0}_0=0bin10 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF z_0_{0}_0=0bin10 AND x_2_{0}_0=0bin01 THEN z_1_{0}_0=0bin11 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF z_0_{0}_0=0bin10 AND x_2_{0}_0=0bin10 THEN z_1_{0}_0=0bin00 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF z_0_{0}_0=0bin10 AND x_2_{0}_0=0bin11 THEN z_1_{0}_0=0bin11 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
