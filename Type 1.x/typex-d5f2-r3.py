...
def set_smtlib2(rounds):
    ...
    smtlib2_constr.append(f"(assert (= (bvand y_0_{rounds-1}_1 y_2_{rounds-1}_1) #b00))\n\n")

    # Constraints
    smtlib2_constr.append("(assert (not (= (concat y_0_0_0 (concat y_1_0_0 (concat y_2_0_0 (concat y_3_0_0 y_4_0_0)))) #b0000000000)))\n")
    for i in range(5):
