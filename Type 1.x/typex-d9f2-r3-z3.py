...
def set_smtlib2(rounds):
    ...
    for r in range(rounds):
        ...
        smtlib2_constr.append(f"(assert (= y_4_{r}_1 y_2_{r}_0))\n")
    ...
    # Constraints
    smtlib2_constr.append("(assert (not (= (concat y_0_0_0 (concat y_1_0_0 (concat y_2_0_0 (concat y_3_0_0 (concat y_4_0_0 (concat y_5_0_0 (concat y_6_0_0 (concat y_7_0_0 y_8_0_0)))))))) #b000000000000000000)))\n")
