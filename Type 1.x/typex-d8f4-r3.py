...
def set_cvc(round):
    ...
    for r in range(round):
        ...
        cvc_constr.append("y_0_{0}_2, y_2_{0}_2, y_4_{0}_2, y_6_{0}_2 : BITVECTOR(2);\n".format(r))
    ...
    for r in range(round):
        ...
        cvc_constr.append("ASSERT y_3_{0}_1 = y_6_{0}_0;\n".format(r))
        cvc_constr.append("ASSERT y_4_{0}_1 = y_7_{0}_0;\n".format(r))
