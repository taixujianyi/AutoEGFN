...
def set_smtlib2(rounds):
    ...
    for r in range(rounds):
        ...
        # Permutation (3 4 5 0 2 1)
        smtlib2_constr.append(f"(assert (= y_0_{r} z_1_{r}_0))\n")
        smtlib2_constr.append(f"(assert (= y_1_{r} x_5_{r}_0))\n")
        smtlib2_constr.append(f"(assert (= y_2_{r} x_4_{r}_0))\n")
    ...
    # Constraints
    smtlib2_constr.append("(assert (not (= (concat x_0_0_0 (concat x_1_0_0 (concat x_2_0_0 (concat x_3_0_0 (concat x_4_0_0 x_5_0_0))))) #b000000000000)))\n")
