...
def set_cvc(round):
    ...
    for r in range(round):
        cvc_constr.append("\nx_0_{0}_0, x_1_{0}_0, x_2_{0}_0, x_3_{0}_0, x_4_{0}_0, x_5_{0}_0, x_6_{0}_0, x_7_{0}_0, x_8_{0}_0 : BITVECTOR(2);\n".format(r))
        cvc_constr.append("z_0_{0}_0, z_1_{0}_0 : BITVECTOR(2);\n".format(r))
        cvc_constr.append("y_0_{0}_0, y_1_{0}_0, y_2_{0}_0, y_3_{0}_0, y_4_{0}_0, y_5_{0}_0, y_6_{0}_0, y_7_{0}_0, y_8_{0}_0 : BITVECTOR(2);\n\n".format(r))
        cvc_constr.append("y_0_{0}_1, y_1_{0}_1, y_2_{0}_1, y_3_{0}_1, y_4_{0}_1, y_5_{0}_1, y_6_{0}_1, y_7_{0}_1, y_8_{0}_1 : BITVECTOR(2);\n\n".format(r))
        cvc_constr.append("y_0_{0}_2, y_2_{0}_2 : BITVECTOR(2);\n".format(r))
    ...
    for r in range(round):
        ...
        #Perm (1 3 4 2 5 6 7 8 0)
        cvc_constr.append("ASSERT y_0_{0}_1 = y_8_{0}_0;\n".format(r))
        ...
        cvc_constr.append("ASSERT y_4_{0}_1 = y_2_{0}_0;\n".format(r))
        cvc_constr.append("ASSERT y_5_{0}_1 = y_4_{0}_0;\n".format(r))
        cvc_constr.append("ASSERT y_6_{0}_1 = y_5_{0}_0;\n".format(r))
        cvc_constr.append("ASSERT y_7_{0}_1 = y_6_{0}_0;\n".format(r))
    ...
    cvc_constr.append("ASSERT y_0_0_0@y_1_0_0@y_2_0_0@y_3_0_0@y_4_0_0@y_5_0_0@y_6_0_0@y_7_0_0@y_8_0_0 /= 0bin000000000000000000;\n")
