...
def set_smtlib2(rounds):
    ...
    for r in range(rounds):
        ...
        smtlib2_constr.append(f"(assert (= y_0_{r} x_4_{r}_0))\n")
    ...
    # Constraints
    smtlib2_constr.append("(assert (not (= (concat x_0_0_0 (concat x_1_0_0 (concat x_2_0_0 (concat x_3_0_0 x_4_0_0)))) #b0000000000)))\n")
    for i in range(5):
