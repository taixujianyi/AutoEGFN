...
def set_cvc(round):
    ...
    for r in range(round):
        ...
        cvc_constr.append("y_0_{0}, y_1_{0}, y_2_{0}, y_3_{0}, y_4_{0}, y_5_{0}, y_6_{0}, y_7_{0}, y_8_{0} : BITVECTOR(2);\n\n".format(r))
    ...
    for r in range(round):
        ...
        cvc_constr.append("ASSERT y_0_{0} = x_8_{0}_0;\n".format(r))
    ...
    cvc_constr.append("ASSERT x_0_0_0@x_1_0_0@x_2_0_0@x_3_0_0@x_4_0_0@x_5_0_0@x_6_0_0@x_7_0_0@x_8_0_0 /= 0bin000000000000000000;\n")
