...
def set_cvc(round):
    ...
    for r in range(round):
        ...
        cvc_constr.append("x_0_{0}_1, x_2_{0}_1, x_4_{0}_1 : BITVECTOR(2);\n".format(r))
    ...
    for r in range(round):
        ...
        #Perm (1 2 4 0 5 6 3)
        cvc_constr.append("ASSERT y_0_{0} = z_1_{0}_0;\n".format(r))
        ...
        cvc_constr.append("ASSERT y_4_{0} = x_2_{0}_0;\n".format(r))
