...
def set_smtlib2(rounds):
    ...
    for r in range(rounds):
        ...
        # Permutation {5,0,7,2,9,6,3,8,1,4}
    ...
    smtlib2_constr.append(f"(assert (= (bvand x_0_{rounds-1}_0 (bvand x_2_{rounds-1}_0 (bvand x_4_{rounds-1}_0 (bvand x_6_{rounds-1}_0 x_8_{rounds-1}_0)))) #b00))\n")
    smtlib2_constr.append("\n")

    # Constraints
    smtlib2_constr.append("(assert (not (= (concat x_0_0_0 (concat x_1_0_0 (concat x_2_0_0 (concat x_3_0_0 (concat x_4_0_0 (concat x_5_0_0 (concat x_6_0_0 (concat x_7_0_0 (concat x_8_0_0 x_9_0_0))))))))) #b00000000000000000000)))\n")
