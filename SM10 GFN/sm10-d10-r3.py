...
def set_smtlib2(rounds):
    ...
    for r in range(rounds):
        ...
        # Permutation {1,8,3,6,9,0,5,2,7,4}
        ...
        smtlib2_constr.append(f"(assert (= y_6_{r}_1 y_3_{r}_0))\n")
    ...
    smtlib2_constr.append(f"(assert (= (bvand y_0_{rounds-1}_1 (bvand y_2_{rounds-1}_1 (bvand y_4_{rounds-1}_1 (bvand y_6_{rounds-1}_1 y_8_{rounds-1}_1)))) #b00))\n")
    smtlib2_constr.append("\n")

    # Constraints
    smtlib2_constr.append("(assert (not (= (concat y_0_0_0 (concat y_1_0_0 (concat y_2_0_0 (concat y_3_0_0 (concat y_4_0_0 (concat y_5_0_0 (concat y_6_0_0 (concat y_7_0_0 (concat y_8_0_0 y_9_0_0))))))))) #b00000000000000000000)))\n")
