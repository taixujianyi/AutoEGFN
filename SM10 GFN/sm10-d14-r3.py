...
def set_smtlib2(rounds):
    ...
    for r in range(rounds):
        ...
        # y variables with different suffixes
        # y_i_1 (odd indices)
    ...
    for r in range(rounds):
        ...
        # Permutation {13,0,1,4,3,12,5,8,7,2,9,10,11,6}
        ...
        smtlib2_constr.append(f"(assert (= y_4_{r}_1 y_3_{r}_0))\n")
        ...
        smtlib2_constr.append(f"(assert (= y_8_{r}_1 y_7_{r}_0))\n")
        ...
        smtlib2_constr.append(f"(assert (= (Table (concat (concat y_12_{r}_2 y_13_{r}_1) z_6_{r}_0)) #b1))\n")
    ...
    # Active variables and constraints
