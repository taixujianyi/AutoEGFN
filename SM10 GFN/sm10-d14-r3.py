...
def set_cvc(round):
    ...
    for r in range(round):
        ...
        cvc_constr.append("y_0_{0}_1, y_2_{0}_1, y_4_{0}_1, y_6_{0}_1, y_8_{0}_1, y_10_{0}_1, y_12_{0}_1 : BITVECTOR(2);\n".format(r))
        cvc_constr.append("y_0_{0}_2, y_2_{0}_2, y_4_{0}_2, y_6_{0}_2, y_8_{0}_2, y_10_{0}_2, y_12_{0}_2 : BITVECTOR(2);\n".format(r))
    ...
    for r in range(round):
        ...
        cvc_constr.append("ASSERT y_12_{0}_1 = y_5_{0}_0;\n".format(r))
        ...
        cvc_constr.append("\n")
        cvc_constr.append("ASSERT IF y_10_{0}_2=0bin00 THEN z_5_{0}_0=y_11_{0}_1 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_10_{0}_2=0bin01 AND y_11_{0}_1=0bin00 THEN z_5_{0}_0=0bin01 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_10_{0}_2=0bin01 AND y_11_{0}_1=0bin01 THEN z_5_{0}_0=0bin00 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_10_{0}_2=0bin01 AND y_11_{0}_1=0bin10 THEN z_5_{0}_0=0bin11 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_10_{0}_2=0bin01 AND y_11_{0}_1=0bin11 THEN z_5_{0}_0=0bin11 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_10_{0}_2=0bin10 AND y_11_{0}_1=0bin00 THEN z_5_{0}_0=0bin10 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_10_{0}_2=0bin10 AND y_11_{0}_1=0bin01 THEN z_5_{0}_0=0bin11 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_10_{0}_2=0bin10 AND y_11_{0}_1=0bin10 THEN z_5_{0}_0=0bin00 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_10_{0}_2=0bin10 AND y_11_{0}_1=0bin11 THEN z_5_{0}_0=0bin11 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_10_{0}_2=0bin11 THEN z_5_{0}_0=0bin11 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("\n")
        cvc_constr.append("ASSERT IF y_12_{0}_2=0bin00 THEN z_6_{0}_0=y_13_{0}_1 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_12_{0}_2=0bin01 AND y_13_{0}_1=0bin00 THEN z_6_{0}_0=0bin01 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_12_{0}_2=0bin01 AND y_13_{0}_1=0bin01 THEN z_6_{0}_0=0bin00 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_12_{0}_2=0bin01 AND y_13_{0}_1=0bin10 THEN z_6_{0}_0=0bin11 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_12_{0}_2=0bin01 AND y_13_{0}_1=0bin11 THEN z_6_{0}_0=0bin11 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_12_{0}_2=0bin10 AND y_13_{0}_1=0bin00 THEN z_6_{0}_0=0bin10 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_12_{0}_2=0bin10 AND y_13_{0}_1=0bin01 THEN z_6_{0}_0=0bin11 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_12_{0}_2=0bin10 AND y_13_{0}_1=0bin10 THEN z_6_{0}_0=0bin00 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_12_{0}_2=0bin10 AND y_13_{0}_1=0bin11 THEN z_6_{0}_0=0bin11 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("ASSERT IF y_12_{0}_2=0bin11 THEN z_6_{0}_0=0bin11 ELSE 0bin1 = 0bin1 ENDIF;\n".format(r))
        cvc_constr.append("\n")
    ...
    cvc_constr.append("ASSERT IF y_4_{0}_1 = 0bin00 THEN active_3 = 0bin0 ELSE active_3 = 0bin1 ENDIF;\n".format(round-1))
    cvc_constr.append("ASSERT IF y_6_{0}_1 = 0bin00 THEN active_4 = 0bin0 ELSE active_4 = 0bin1 ENDIF;\n".format(round-1))
    cvc_constr.append("ASSERT IF y_8_{0}_1 = 0bin00 THEN active_5 = 0bin0 ELSE active_5 = 0bin1 ENDIF;\n".format(round-1))
    cvc_constr.append("ASSERT IF y_10_{0}_1 = 0bin00 THEN active_6 = 0bin0 ELSE active_6 = 0bin1 ENDIF;\n".format(round-1))
    cvc_constr.append("ASSERT IF y_12_{0}_1 = 0bin00 THEN active_7 = 0bin0 ELSE active_7 = 0bin1 ENDIF;\n".format(round-1))
