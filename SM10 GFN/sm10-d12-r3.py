...
def set_cvc(round):
    ...
    for r in range(round):
        ...
        cvc_constr.append("y_0_{0}_1, y_2_{0}_1, y_4_{0}_1, y_6_{0}_1, y_8_{0}_1, y_10_{0}_1 : BITVECTOR(2);\n".format(r))
        cvc_constr.append("y_1_{0}_1, y_3_{0}_1, y_5_{0}_1, y_7_{0}_1, y_9_{0}_1, y_11_{0}_1 : BITVECTOR(2);\n".format(r))
        cvc_constr.append("y_0_{0}_2, y_2_{0}_2, y_4_{0}_2, y_6_{0}_2, y_8_{0}_2, y_10_{0}_2 : BITVECTOR(2);\n".format(r))
    ...
    for r in range(round):
        ...
        #Perm {1,10,3,0,5,8,11,2,7,4,9,6}
        ...
        cvc_constr.append("ASSERT y_5_{0}_1 = y_4_{0}_0;\n".format(r))
        cvc_constr.append("ASSERT y_6_{0}_1 = y_11_{0}_0;\n".format(r))
        cvc_constr.append("ASSERT y_7_{0}_1 = y_8_{0}_0;\n".format(r))
        cvc_constr.append("ASSERT y_8_{0}_1 = y_5_{0}_0;\n".format(r))
        cvc_constr.append("ASSERT y_9_{0}_1 = y_10_{0}_0;\n".format(r))
        cvc_constr.append("ASSERT y_10_{0}_1 = y_1_{0}_0;\n".format(r))
        cvc_constr.append("ASSERT y_11_{0}_1 = y_6_{0}_0;\n".format(r))
        cvc_constr.append("%%%%%%%%%%%%\n\n")
    ...
    cvc_constr.append("ASSERT y_0_{0}_1 & y_2_{0}_1 & y_4_{0}_1 & y_6_{0}_1 & y_8_{0}_1 & y_10_{0}_1 = 0bin00;\n".format(round-1))
    cvc_constr.append("\n")
