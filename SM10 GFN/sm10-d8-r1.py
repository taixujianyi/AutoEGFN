...
def set_smtlib2(rounds):
    ...
    for r in range(rounds):
        ...
        smtlib2_constr.append(f"(assert (= y_7_{r} x_4_{r}_0))\n")
        smtlib2_constr.append("\n")

    smtlib2_constr.append(f"(assert (= (bvand x_0_{rounds-1}_0 (bvand x_2_{rounds-1}_0 (bvand x_4_{rounds-1}_0 x_6_{rounds-1}_0))) #b00))\n")
    smtlib2_constr.append("\n")
