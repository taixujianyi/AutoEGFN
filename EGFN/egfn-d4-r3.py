...
def set_smtlib2_stp(rounds):
    ...
    for r in range(rounds):
        ...
        # XOR
        smtlib2_constr.append(f"(assert (= (Table (concat (concat y_1_{r}_1 y_3_{r}_1) z_3_{r}_0)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat y_0_{r}_1 y_2_{r}_1) z_2_{r}_0)) #b1))\n")
        ...
        # XOR
        smtlib2_constr.append(f"(assert (= (Table (concat (concat y_0_{r}_2 z_3_{r}_0) z_3_{r}_1)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat y_1_{r}_2 z_2_{r}_0) z_2_{r}_1)) #b1))\n")
