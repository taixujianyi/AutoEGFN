...
def set_smtlib2(rounds):
    ...
    for r in range(rounds):
        ...
        smtlib2_constr.append(f"(declare-fun z_3_{r}_2 () (_ BitVec 2))\n")
        smtlib2_constr.append(f"(declare-fun z_3_{r}_3 () (_ BitVec 2))\n")
    ...
    for r in range(rounds):
        ...
        # XOR
        smtlib2_constr.append(f"(assert (= (Table (concat (concat x_3_{r}_1 x_4_{r}_0) z_0_{r}_0)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat x_2_{r}_1 x_5_{r}_0) z_1_{r}_0)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat x_1_{r}_1 x_6_{r}_0) z_2_{r}_0)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat x_0_{r}_1 x_7_{r}_0) z_3_{r}_0)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat x_1_{r}_0 z_3_{r}_0) z_3_{r}_1)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat x_2_{r}_0 z_3_{r}_1) z_3_{r}_2)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat x_3_{r}_0 z_3_{r}_2) z_3_{r}_3)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat x_3_{r}_0 z_2_{r}_0) z_2_{r}_1)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat x_3_{r}_0 z_1_{r}_0) z_1_{r}_1)) #b1))\n")

        # Permutation
        smtlib2_constr.append(f"(assert (= y_0_{r} z_0_{r}_0))\n")
        smtlib2_constr.append(f"(assert (= y_1_{r} z_1_{r}_1))\n")
        smtlib2_constr.append(f"(assert (= y_2_{r} z_2_{r}_1))\n")
        smtlib2_constr.append(f"(assert (= y_3_{r} z_3_{r}_3))\n")
        smtlib2_constr.append(f"(assert (= y_4_{r} x_0_{r}_0))\n")
        smtlib2_constr.append(f"(assert (= y_5_{r} x_1_{r}_0))\n")
        smtlib2_constr.append(f"(assert (= y_6_{r} x_2_{r}_0))\n")
        smtlib2_constr.append(f"(assert (= y_7_{r} x_3_{r}_0))\n\n")
    ...
    concat_expr = "(concat x_0_0_0 (concat x_1_0_0 (concat x_2_0_0 (concat x_3_0_0 (concat x_4_0_0 (concat x_5_0_0 (concat x_6_0_0 x_7_0_0)))))))"
