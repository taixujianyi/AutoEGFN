...
def set_smtlib2(rounds):
    ...
    for r in range(rounds):
        ...
        smtlib2_constr.append(create_xor_assertion(f"z_0_{r}_0", f"x_3_{r}_1", f"x_4_{r}_0", r))
        smtlib2_constr.append("\n")

        smtlib2_constr.append(create_xor_assertion(f"z_1_{r}_0", f"x_2_{r}_1", f"x_5_{r}_0", r))
        smtlib2_constr.append("\n")

        smtlib2_constr.append(create_xor_assertion(f"z_2_{r}_0", f"x_1_{r}_1", f"x_6_{r}_0", r))
        smtlib2_constr.append("\n")

        smtlib2_constr.append(create_xor_assertion(f"z_3_{r}_0", f"x_0_{r}_1", f"x_7_{r}_0", r))
        smtlib2_constr.append("\n")

        smtlib2_constr.append(create_xor_assertion(f"z_3_{r}_1", f"x_1_{r}_0", f"z_3_{r}_0", r))
        smtlib2_constr.append("\n")

        smtlib2_constr.append(create_xor_assertion(f"z_3_{r}_2", f"x_2_{r}_0", f"z_3_{r}_1", r))
        smtlib2_constr.append("\n")

        smtlib2_constr.append(create_xor_assertion(f"z_3_{r}_3", f"x_3_{r}_0", f"z_3_{r}_2", r))
        smtlib2_constr.append("\n")

        smtlib2_constr.append(create_xor_assertion(f"z_2_{r}_1", f"x_3_{r}_0", f"z_2_{r}_0", r))
        smtlib2_constr.append("\n")

        smtlib2_constr.append(create_xor_assertion(f"z_1_{r}_1", f"x_3_{r}_0", f"z_1_{r}_0", r))
        smtlib2_constr.append("\n")
