...
def set_smtlib2_stp(rounds):
    ...
    for r in range(rounds):
        ...
        # XOR
        smtlib2_constr.append(f"(assert (= (Table (concat (concat x_0_{r}_1 x_3_{r}_0) z_0_{r}_0)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat x_1_{r}_1 x_2_{r}_0) z_1_{r}_0)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat x_1_{r}_0 z_0_{r}_0) z_0_{r}_1)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat x_0_{r}_0 z_1_{r}_0) z_1_{r}_1)) #b1))\n")
