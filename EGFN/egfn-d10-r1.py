...
def set_smtlib2(rounds):
    ...
    for r in range(rounds):
        ...
        # XOR
        smtlib2_constr.append(f"(assert (= (Table (concat (concat x_4_{r}_1 x_5_{r}_0) z_5_{r}_0)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat x_3_{r}_1 x_6_{r}_0) z_6_{r}_0)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat x_2_{r}_1 x_7_{r}_0) z_7_{r}_0)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat x_1_{r}_1 x_8_{r}_0) z_8_{r}_0)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat x_0_{r}_1 x_9_{r}_0) z_9_{r}_0)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat x_1_{r}_0 z_9_{r}_0) z_9_{r}_1)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat x_2_{r}_0 z_9_{r}_1) z_9_{r}_2)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat x_3_{r}_0 z_9_{r}_2) z_9_{r}_3)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat x_4_{r}_0 z_9_{r}_3) z_9_{r}_4)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat x_4_{r}_0 z_8_{r}_0) z_8_{r}_1)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat x_4_{r}_0 z_7_{r}_0) z_7_{r}_1)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat x_4_{r}_0 z_6_{r}_0) z_6_{r}_1)) #b1))\n")
