...
def set_smtlib2(rounds):
    ...
    for r in range(rounds):
        ...
        # XOR
        smtlib2_constr.append(f"(assert (= (Table (concat (concat y_2_{r}_1 y_4_{r}_1) z_4_{r}_0)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat y_2_{r}_1 y_5_{r}_1) z_5_{r}_0)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat y_1_{r}_1 z_5_{r}_0) z_5_{r}_1)) #b1))\n")
        ...
        # XOR
        smtlib2_constr.append(f"(assert (= (Table (concat (concat y_0_{r}_2 z_5_{r}_1) z_5_{r}_2)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat y_1_{r}_2 z_4_{r}_0) z_4_{r}_1)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat y_2_{r}_2 y_3_{r}_1) z_3_{r}_0)) #b1))\n")
