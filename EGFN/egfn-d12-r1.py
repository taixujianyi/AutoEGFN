...
def set_smtlib2(rounds):
    ...
    for r in range(rounds):
        ...
        smtlib2_constr.append(create_xor_assertion(f"z_6_{r}_0", f"x_5_{r}_1", f"x_6_{r}_0"))
        smtlib2_constr.append("\n")

        smtlib2_constr.append(create_xor_assertion(f"z_7_{r}_0", f"x_4_{r}_1", f"x_7_{r}_0"))
        smtlib2_constr.append("\n")

        smtlib2_constr.append(create_xor_assertion(f"z_8_{r}_0", f"x_3_{r}_1", f"x_8_{r}_0"))
        smtlib2_constr.append("\n")

        smtlib2_constr.append(create_xor_assertion(f"z_9_{r}_0", f"x_2_{r}_1", f"x_9_{r}_0"))
        smtlib2_constr.append("\n")

        smtlib2_constr.append(create_xor_assertion(f"z_10_{r}_0", f"x_1_{r}_1", f"x_10_{r}_0"))
        smtlib2_constr.append("\n")

        smtlib2_constr.append(create_xor_assertion(f"z_11_{r}_0", f"x_0_{r}_1", f"x_11_{r}_0"))
        smtlib2_constr.append("\n")

        smtlib2_constr.append(create_xor_assertion(f"z_11_{r}_1", f"x_1_{r}_0", f"z_11_{r}_0"))
        smtlib2_constr.append("\n")

        smtlib2_constr.append(create_xor_assertion(f"z_11_{r}_2", f"x_2_{r}_0", f"z_11_{r}_1"))
        smtlib2_constr.append("\n")

        smtlib2_constr.append(create_xor_assertion(f"z_11_{r}_3", f"x_3_{r}_0", f"z_11_{r}_2"))
        smtlib2_constr.append("\n")

        smtlib2_constr.append(create_xor_assertion(f"z_11_{r}_4", f"x_4_{r}_0", f"z_11_{r}_3"))
        smtlib2_constr.append("\n")

        smtlib2_constr.append(create_xor_assertion(f"z_11_{r}_5", f"x_5_{r}_0", f"z_11_{r}_4"))
        smtlib2_constr.append("\n")

        smtlib2_constr.append(create_xor_assertion(f"z_10_{r}_1", f"x_5_{r}_0", f"z_10_{r}_0"))
        smtlib2_constr.append("\n")

        smtlib2_constr.append(create_xor_assertion(f"z_9_{r}_1", f"x_5_{r}_0", f"z_9_{r}_0"))
        smtlib2_constr.append("\n")

        smtlib2_constr.append(create_xor_assertion(f"z_8_{r}_1", f"x_5_{r}_0", f"z_8_{r}_0"))
        smtlib2_constr.append("\n")

        smtlib2_constr.append(create_xor_assertion(f"z_7_{r}_1", f"x_5_{r}_0", f"z_7_{r}_0"))
        smtlib2_constr.append("\n")
