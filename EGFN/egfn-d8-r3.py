...
def set_smtlib2(rounds):
    ...
    for r in range(rounds):
        ...
        smtlib2_constr.append(f"(declare-fun z_6_{r}_1 () (_ BitVec 2))\n")
        smtlib2_constr.append(f"(declare-fun z_7_{r}_0 () (_ BitVec 2))\n")
        smtlib2_constr.append(f"(declare-fun z_7_{r}_1 () (_ BitVec 2))\n")
        smtlib2_constr.append(f"(declare-fun z_7_{r}_2 () (_ BitVec 2))\n")
        smtlib2_constr.append(f"(declare-fun z_7_{r}_3 () (_ BitVec 2))\n")
    ...
    for r in range(rounds):
        ...
        # Permutation
        smtlib2_constr.append(f"(assert (= y_0_{r}_1 y_4_{r}_0))\n")
        smtlib2_constr.append(f"(assert (= y_1_{r}_1 y_5_{r}_0))\n")
        smtlib2_constr.append(f"(assert (= y_2_{r}_1 y_6_{r}_0))\n")
        smtlib2_constr.append(f"(assert (= y_3_{r}_1 y_7_{r}_0))\n")
        smtlib2_constr.append(f"(assert (= y_4_{r}_1 y_0_{r}_0))\n")
        smtlib2_constr.append(f"(assert (= y_5_{r}_1 y_1_{r}_0))\n")
        smtlib2_constr.append(f"(assert (= y_6_{r}_1 y_2_{r}_0))\n")
        smtlib2_constr.append(f"(assert (= y_7_{r}_1 y_3_{r}_0))\n\n")

        # XOR
        smtlib2_constr.append(f"(assert (= (Table (concat (concat y_3_{r}_1 y_5_{r}_1) z_5_{r}_0)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat y_3_{r}_1 y_6_{r}_1) z_6_{r}_0)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat y_3_{r}_1 y_7_{r}_1) z_7_{r}_0)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat y_2_{r}_1 z_7_{r}_0) z_7_{r}_1)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat y_1_{r}_1 z_7_{r}_1) z_7_{r}_2)) #b1))\n")
        ...
        smtlib2_constr.append(f"(assert (= y_3_{r}_2 (ite (= y_3_{r}_1 #b00) #b00 #b11)))\n")
        smtlib2_constr.append("\n")

        # XOR
        smtlib2_constr.append(f"(assert (= (Table (concat (concat y_0_{r}_2 z_7_{r}_2) z_7_{r}_3)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat y_1_{r}_2 z_6_{r}_0) z_6_{r}_1)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat y_2_{r}_2 z_5_{r}_0) z_5_{r}_1)) #b1))\n")
        smtlib2_constr.append(f"(assert (= (Table (concat (concat y_3_{r}_2 y_4_{r}_1) z_4_{r}_0)) #b1))\n")
        ...
        smtlib2_constr.append(f"(assert (= x_5_{r}_0 z_5_{r}_1))\n")
        smtlib2_constr.append(f"(assert (= x_6_{r}_0 z_6_{r}_1))\n")
        smtlib2_constr.append(f"(assert (= x_7_{r}_0 z_7_{r}_3))\n\n")
    ...
    smtlib2_constr.append(f"(assert (= active_4 (ite (= y_3_{rounds-1}_1 #b00) #b0 #b1)))\n")
    
    and_expr = "(bvand active_1 (bvand active_2 (bvand active_3 active_4)))"
    smtlib2_constr.append(f"(assert (= {and_expr} #b0))\n\n")

    concat_expr = "(concat y_0_0_0 (concat y_1_0_0 (concat y_2_0_0 (concat y_3_0_0 (concat y_4_0_0 (concat y_5_0_0 (concat y_6_0_0 y_7_0_0)))))))"
    smtlib2_constr.append(f"(assert (not (= {concat_expr} #b0000000000000000)))\n")
    for i in range(8):
