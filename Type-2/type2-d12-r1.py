...
def set_smtlib2(rounds):
    ...
    smtlib2_constr.append(f"(assert (= (bvand x_0_{rounds-1}_0 (bvand x_2_{rounds-1}_0 (bvand x_4_{rounds-1}_0 (bvand x_6_{rounds-1}_0 (bvand x_8_{rounds-1}_0 x_10_{rounds-1}_0))))) #b00))\n\n")
