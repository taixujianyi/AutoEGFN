...
def set_smtlib2(rounds):
    ...
    smtlib2_constr.append(f"(assert (= (bvand y_1_{rounds-1}_0 (bvand y_3_{rounds-1}_0 (bvand y_5_{rounds-1}_0 (bvand y_7_{rounds-1}_0 (bvand y_9_{rounds-1}_0 y_11_{rounds-1}_0))))) #b00))\n\n")
