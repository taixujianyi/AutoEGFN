...
def set_smtlib2_stp(rounds):
    ...
    for r in range(rounds):
        ...
        smtlib2_constr.append(
            f"(assert (= z_0_{r}_0\n"
            f"    (ite (= y_7_{r}_1 #b00) y_0_{r}_0\n"
            f"         (ite (and (= y_7_{r}_1 #b01) (= y_0_{r}_0 #b00)) #b01\n"
            f"         (ite (and (= y_7_{r}_1 #b01) (= y_0_{r}_0 #b01)) #b01\n"
            f"         (ite (and (= y_7_{r}_1 #b01) (= y_0_{r}_0 #b10)) #b11\n"
            f"         (ite (and (= y_7_{r}_1 #b01) (= y_0_{r}_0 #b11)) #b11\n"
            f"         (ite (and (= y_7_{r}_1 #b10) (= y_0_{r}_0 #b00)) #b10\n"
            f"         (ite (and (= y_7_{r}_1 #b10) (= y_0_{r}_0 #b01)) #b11\n"
            f"         (ite (and (= y_7_{r}_1 #b10) (= y_0_{r}_0 #b10)) #b10\n"
            f"         (ite (and (= y_7_{r}_1 #b10) (= y_0_{r}_0 #b11)) #b11\n"
    ...
    smtlib2_constr.append(f"(assert (= active_1 (ite (= y_7_{rounds-1}_0 #b00) #b0 #b1)))\n")
    smtlib2_constr.append("(assert (= active_1 #b0))\n\n")

    smtlib2_constr.append(
        "(assert (not (= (concat (concat (concat (concat y_0_0_0 y_1_0_0) (concat y_2_0_0 y_3_0_0)) (concat y_4_0_0 y_5_0_0)) (concat y_6_0_0 y_7_0_0)) #b0000000000000000)))\n"
    )
