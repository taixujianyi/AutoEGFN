...
def set_smtlib2_stp(rounds):
    ...
    for r in range(rounds):
        ...
        # XOR
        smtlib2_constr.append(f"(assert (= (Table (concat (concat y_13_{r}_1 y_0_{r}_0) z_0_{r}_0)) #b1))\n")
    ...
    smtlib2_constr.append(f"(assert (= y_13_{rounds-1}_0 #b00))\n")
    smtlib2_constr.append("\n")

    smtlib2_constr.append(
        "(assert (not (= (concat (concat (concat (concat (concat (concat (concat y_0_0_0 y_1_0_0) (concat y_2_0_0 y_3_0_0)) (concat y_4_0_0 y_5_0_0)) (concat y_6_0_0 y_7_0_0)) (concat y_8_0_0 y_9_0_0)) (concat y_10_0_0 y_11_0_0)) (concat y_12_0_0 y_13_0_0)) #b0000000000000000000000000000)))\n"
    )
